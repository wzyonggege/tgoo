                    ...
                    <>
                      ...
                      <div className="mb-4">
                        ...
                        <input
                          ...
                          placeholder={t('settings.staff.assignmentModelPlaceholder', '例如：fastgpt:gpt-4o-mini')}
                        />
                        <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
                          {t('settings.staff.assignmentModelHint', '可选：标记希望用于智能分配的大模型名称')}
                        </p>
                      </div>
